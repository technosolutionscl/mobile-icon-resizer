...
function executeResize(options, callback) {
  ...
  if(options.platform && (options.platform=='ios' && options.options.removeAlpha || options.platform=='android' && options.options.androidPlaystoreIconBG && options.outputFile.indexOf('playstore-icon')!=-1))
